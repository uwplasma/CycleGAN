...
def calculate_loss_fraction_SIMPLE(local_wout, stel, rank, SIMPLE_executable, SIMPLE_input, SIMPLE_output, s=0.3, trace_time=1e-2, B_aries = 5.7, A_aries = 1.7, nparticles=5000):
